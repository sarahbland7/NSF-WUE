...
set(figure(1),'name','Yearly Discharge Values','numbertitle','off')
...
for i = 1:23
    ...
    ave_wyQ1(i) = conversion(mean(PAIN_cfs(ii)))/12400000;
...
subplot(2,5,6)
bar(wy, ave_wyQ1)                  %plots years on x-axis by m/wy
xlabel('Year');
...
for i = 1:23
    ...
    ave_wyQ2(i) = conversion(mean(STAN_cfs(ii)))/10500000;
...
for i = 1:23
    ...
    ave_wyQ3(i) = conversion(mean(PINE_cfs(ii)))/12600000;
...
ave_wyQ4 = zeros(1, 23);
for i = 1:23
    ii = find((WOR_year1 == (wy(i) - 1) & WOR_quart1 == 4) | (WOR_year1 == wy(i) & WOR_quart1 < 4));
    ave_wyQ4(i) = conversion(mean(WOR_cfs1(ii)))/5150000;
...
for i = 1:36
    ...
    ave_wyQ5(i) = conversion(mean(WOR_cfs2(ii)))/5150000;
    %Catchment Area = 515 ha = 5.15 km^2 * 1000000 m^2/km^2 = 5150000 m^2 
end
